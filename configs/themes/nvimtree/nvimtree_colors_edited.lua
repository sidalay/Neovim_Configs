...
local function get_hl_groups()
  ...
  return {
    ...
    FolderIcon = { fg = colors.purple },
    RootFolder = { fg = colors.blue },

    ExecFile = { gui = "bold", fg = colors.purple },
    SpecialFile = { gui = "bold", fg = "#86DA6D" },
    ImageFile = { gui = "bold", fg = colors.yellow },
    OpenedFile = { gui = "bold", fg = colors.purple },
    ...
    WindowPicker = { gui = "bold", fg = colors.purple, bg = "#141515" },
  }
end
